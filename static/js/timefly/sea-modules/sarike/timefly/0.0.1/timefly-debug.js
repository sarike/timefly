...
define("sarike/timefly/0.0.1/common/base/base-debug", [ "sarike/timefly/0.0.1/libs/libs-debug", "$-debug", "gallery/underscore/1.4.4/underscore-debug", "gallery/backbone/1.0.0/backbone-debug", "sarike/jquery-ui/1.10.3/jquery-ui-debug", "sarike/jquery-noty/2.1.0/jquery-noty-debug", "sarike/jquery-validate/1.11.1/jquery-validate-debug" ], function(require, exports, module) {
    ...
    var Header = Backbone.View.extend({
        ...
        doReg: function() {},
        addNewTodo: function() {
            var addTodoModalTemplate = require("sarike/timefly/0.0.1/common/base/templates/add_todo_modal-debug.tpl");
...
define("sarike/timefly/0.0.1/common/box/templates/about_box-debug.tpl", [], '<span class="copyright">&copy; 2013</span> <a href="#">关于</a>');
